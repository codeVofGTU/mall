...
public class MysqlGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://rm-8vbw1k484noyecox5ao.mysql.zhangbei.rds.aliyuncs.com:3306/mall?useUnicode=true&serverTimezone=GMT&useSSL=false&characterEncoding=utf8");
        // dsc.setSchemaName("public");
        dsc.setDriverName("com.mysql.jdbc.Driver");
        dsc.setUsername("mall");
        dsc.setPassword("mall@@1234");
